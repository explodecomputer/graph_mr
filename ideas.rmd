...
```{r }
load("empirical_analysis.rdata")
```

Instruments were extracted for each trait (`r nrow(exposure_dat)` in total), and each of those instruments was extracted from each trait, thus enabling a 2-sample MR analysis of each trait against each of the other traits. 
