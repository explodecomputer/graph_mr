...
An alternative way to check significance of a path is to permute. Here the off diagonal elements of the matrix of p-values are permuted, preserving the diagonal elements. 
